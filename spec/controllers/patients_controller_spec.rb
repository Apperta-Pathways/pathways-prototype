...
RSpec.describe PatientsController, type: :controller do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Patient" do
        expect { creating_patient }.to change(Patient, :count).by(1)
      end
  ...
  describe "PUT update" do
    ...
    describe "with invalid params" do
      it "assigns the patient as @patient" do
        patient = Patient.create! valid_attributes
        put :update, { patient: patient.to_param, patient: invalid_attributes }, valid_session
        expect(assigns(:patient)).to eq(patient)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested patient" do
      patient = Patient.create! valid_attributes
      expect { deleting patient }.to change(Patient, :count).by(-1)
    end
